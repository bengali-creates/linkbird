    ...
    <div className={`relative w-[500px] ${className}`}>
      ...
      {showGradients && (
        <>
          ...
          ></div>
          <div
            className="absolute bottom-0 left-0 right-0 h-[100px] bg-gradient-to-t from-[#e7e6e900] to-transparent pointer-events-none transition-opacity duration-300 ease"
